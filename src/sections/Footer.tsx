...
const quickLinks = [
  ...
  { label: 'Login Anggota', href: 'https://member.kopmantara.co.id', isExternal: true },
                ...
                <li key={link.label}>
                  {link.isExternal ? (
                    <a
                      ...
                      className="font-body text-[14px] text-gold hover:text-white transition-colors flex items-center gap-1 font-medium"
                    >
                      {link.label}
