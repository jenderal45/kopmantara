          ...
          <div className="hidden lg:block">
            <a
              ...
              className={`inline-flex items-center gap-2 px-7 py-2.5 rounded-full text-[15px] font-body font-medium transition-all duration-300 ${
                scrolled
                  ? 'bg-forest text-white hover:bg-emerald shadow-sm'
                  : 'bg-forest/90 text-white hover:bg-forest backdrop-blur-sm'
              }`}
            >
          ...
          <div className="px-4 py-4 space-y-1">
            ...
            <div className="pt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full px-7 py-3 bg-forest text-white rounded-full text-sm font-medium hover:bg-emerald transition-colors"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" />
                  <circle cx="12" cy="7" r="4" />
